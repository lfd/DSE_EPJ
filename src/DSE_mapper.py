...
What it does (like your script):
- Loads all .qasm circuits from --circuits-dir
- For each "device coupling map" in a set (Bristlecone + optional random/density-extended maps)
- Sweeps: optimization_level, routing_method, layout_method, and "setup" variants (PassManager presets)
- Writes one flat table to CSV and/or Excel

Notes:
- This script does *transpilation* + collects metrics (depth, swaps, 2q gate counts, etc.)
- It does NOT run simulation or noise models.
"""
